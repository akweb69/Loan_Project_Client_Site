...
import AfterAbedon from './AfterAbedon';
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    className="mt-1 w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none cursor-not-allowed"
                                                />
                                            </div>
